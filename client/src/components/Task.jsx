			...
			axios
				...
				.then(() => {
					const dueDate = new Date(
						`${this.getDueDate(true)}T17:00:00`
					);
					const newTaskObject = {
						_id: this.state.task._id,
						title: this.state.task.title,
				...
				{this.state.editTask ? (
					...
					<div>
						...
						this.state.task.status === "Finished" ? (
							<div>
								<button onClick={this.handleReopenTask}>
									Reopen Task
								</button>
							</div>
						) : null}
